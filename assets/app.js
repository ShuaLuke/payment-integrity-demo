...
(function () {
  ...
  var APP = {
    ...
    SUBS: {
      ...
      insights: [{ v: "analytics", l: "Overview" }, { v: "network", l: "Network" }, { v: "businesses", l: "Businesses" }, { v: "heatmap", l: "Heatmap" }, { v: "edi", l: "EDI" }, { v: "member", l: "Members" }],
      library: [{ v: "rules", l: "Rules" }, { v: "discovery", l: "Discovery" }, { v: "models", l: "Models" }, { v: "codelibraries", l: "Code libraries" }, { v: "methodologies", l: "Pricing" }, { v: "payersetup", l: "Payer setup" }, { v: "releases", l: "Releases" }, { v: "audit", l: "Audit" }]
    },
    ...
    VIEW_AREA: { home: "home", queue: "casework", claim: "casework", investigations: "casework", approvals: "casework", casereviews: "casework", team: "casework", provider: "insights", analytics: "insights", network: "insights", businesses: "insights", business: "insights", heatmap: "insights", edi: "insights", member: "insights", rules: "library", discovery: "library", models: "library", codelibraries: "library", methodologies: "library", payersetup: "library", releases: "library", audit: "library", portal: "portal" },
    ...
    labelForSnap: function (s) {
      ...
      var map = { queue: "Leads", home: "Home", investigations: "Cases", approvals: "Approvals", casereviews: "Case reviews", analytics: "Analytics", network: "Network", businesses: "Businesses", heatmap: "Heatmap", edi: "EDI", member: "Member", rules: "Rules", discovery: "Discovery", models: "Models", codelibraries: "Code libraries", methodologies: "Pricing", payersetup: "Payer setup", releases: "Releases", audit: "Audit" };
