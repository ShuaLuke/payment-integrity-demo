...
(function () {
  ...
  var APP = {
    ...
    SUBS: {
      ...
      library: [{ v: "rules", l: "Rules" }, { v: "discovery", l: "Discovery" }, { v: "releases", l: "Releases" }, { v: "audit", l: "Audit" }]
    },
    ...
    labelForSnap: function (s) {
      ...
      var map = { queue: "Leads", home: "Home", investigations: "Cases", approvals: "Approvals", casereviews: "Case reviews", analytics: "Analytics", network: "Network", businesses: "Businesses", heatmap: "Heatmap", rules: "Rules", discovery: "Discovery", releases: "Releases", audit: "Audit" };
