...
(function () {
  ...
  var STEPS = [
    ...
    { t: "Priced against CMS", n: "Pricing compares the submitted charge against CMS reference pricing (via Zellis), line by line. The level-5 visit sits well above the CMS-allowed amount — the recoverable exposure is called out at the bottom.", a: function () { retro(); window.APP.openAllegation("20481"); tab("pricing"); } },
