...
(function () {
  ...
  var STEPS = [
    ...
    { t: "Pricing — against CMS", n: "Pricing compares the submitted charge to the CMS-allowed amount per line, using the right methodology and locality, and calls out the recoverable overpayment. Each pricing rule carries its version history — the fee schedule that applied on the date of service.", a: function () { retro(); window.APP.openAllegation("20481"); tab("pricing"); } },
