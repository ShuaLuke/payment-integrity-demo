...
(function () {
  ...
  var STEPS = [
    ...
    { t: "AI summarizes for adjudication", n: "Ask the copilot to “Summarize this case for adjudication.” It talks through the anomaly, the evidence, the network signal (“not a one-off”) and a recommended action — citing historical precedents — and its button drops you on the right decision.", a: function () { retro(); window.APP.openAllegation("20544"); if (window.COPILOT) window.COPILOT.summarize("20544"); } },
    { t: "Case management — analyst decides", n: "On the Decision tab the analyst chooses Confirm, clicks “Draft with AI” for the rationale, and submits. It routes to a supervisor — the money does NOT move to recovery yet.", a: function () { retro(); closeCopilot(); window.APP.openAllegation("20481"); tab("decision"); } },
