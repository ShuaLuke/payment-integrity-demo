...
(function () {
  ...
  var STEPS = [
    ...
    { t: "Priced against CMS", n: "Pricing compares the submitted charge against CMS reference pricing, line by line — the level-5 visit sits well above the CMS-allowed amount, and the recoverable exposure is called out. Each pricing rule also carries its version history: click one for the prior fee-schedule versions and what changed.", a: function () { retro(); window.APP.openAllegation("20481"); tab("pricing"); } },
    { t: "Clinical guidelines & graphs", n: "Utilization runs the claim against evidence-based clinical care guidelines — level of care and criteria met/not-met: medical necessity, not just coding. The Analysis tab adds the peer 99215 mix, an exposure breakdown and volume-over-time — the evidence behind the score.", a: function () { retro(); window.APP.openAllegation("20481"); tab("utilization"); } },
