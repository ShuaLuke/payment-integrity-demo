  ...
  window.Views.supervisor = {
    render: function (mount) {
      function draw() {
        ...
        mount.innerHTML =
          '<div class="page">' +
          '<div class="page-head"><div><div class="page-title">Supervisor review</div><div class="page-sub">Approve or return analyst decisions before recovery or investigation proceeds</div></div>' +
      ...
      function card(p) {
        ...
        var outLbl = out === "confirm" ? "Confirm → recovery" : "Escalate → investigation";
        ...
        return '<div class="card" style="margin-bottom:10px">' +
          ...
          '<button class="btn" data-open="' + a.id + '"><i class="ti ti-external-link"></i> Open full claim</button>' +
